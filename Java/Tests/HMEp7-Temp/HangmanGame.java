...
public class HangmanGame extends JFrame implements ActionListener {
    ...
    public static void makeGuess(char ch) {
        ...
        System.out.println("Concealed word: " + concealedWord);

        // Check if concealedWord matches the secret word, if so game won
        if (concealedWord.replaceAll("\\s+", "").equals(secretWord) == true) {
            //Game won
    ...
    public static void newGame() {
        ...
        // Re-enable all keyboard keys buttons
        enableButtons();
    ...
    public static void enableButtons() {
        arrTopKeys.forEach(x -> { x.setEnabled(true); } );
        arrMidKeys.forEach(x -> { x.setEnabled(true); } );
        arrBotKeys.forEach(x -> { x.setEnabled(true); } );
    }

    // Method to disable all buttons
    public static void disableButtons() {
        arrTopKeys.forEach( x -> { x.setEnabled(false); } );
