/*
 * sketch_mar26a-espwifi-oled-test-backup.ino
 * Date: 2017-03-26
 * 
...
// ESP8266/OLED test - Display ESP connection status with 0.96" I2C OLED
// Started: 26 Mar 2017 23:42
// Revised: 31 Mar 2017 23:07
...
const char* ssid      = "WIFI_SSID_HERE";     // WiFi SSID to connnect to
...
void loop() {
  ...
  if (ledState == 0) {
    u8g2.drawStr(20,63,"LED status: OFF");
  } else {
...
// This function is called whenever the root page is accessed 
void handleRoot() {
  String resp = "\
<!DOCTYPE html>\n\
<html>\n\
...
// Turns the LED on, redirects back to root page
void turnLedOn() {
  ledState = 1;
...
// Turns the LED off, redirects back to root page
void turnLedOff() {
  ledState = 0;
